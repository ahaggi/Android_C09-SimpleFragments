...
public class Vg_WebViewFragment extends WebViewFragment {

    private static final String DEBUG_TAG = "VGWebViewFragment";

    public static Vg_WebViewFragment newInstance(int index) {
        Log.v(DEBUG_TAG, "Creating new instance: " + index);
        Vg_WebViewFragment fragment = new Vg_WebViewFragment();
